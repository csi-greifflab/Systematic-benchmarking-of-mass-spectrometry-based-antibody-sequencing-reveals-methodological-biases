...
```{r}
# Kruskal Wallis test on the vdj coverage rank of the replicates
...
stat_pvalue_manual(data = rep_pwc_vdj, hide.ns = TRUE, label = "p.adj.signif", label.size = 4) +
...
labs(x = "# of merged experimental replicates", y = "Median VDJ coverage, %") +
theme_bw() +
...
geom_point(aes(color = as.factor(value)), size = 2) +
geom_text(aes(x = subset_count, y = 2, label = round(median, 1)), size = 2) +
stat_pvalue_manual(data = rep_pwc_cdr3, hide.ns = TRUE, label = "p.adj.signif", label.size = 4) +
facet_grid(sequence_name~value) +
scale_fill_manual(values = c("#90E0EF", "#00B4D8", "#0077B6", "#03045E")) + 
scale_color_manual(values = c("#90E0EF", "#00B4D8", "#0077B6", "#03045E")) +
scale_x_continuous(limits = c(0.75,4.25)) +
scale_y_continuous(limits = c(0,112), breaks = c(0,25,50,75,100)) +
labs(x = "# of merged experimental replicates", y = "Median CDRH3 coverage, %") +
theme_bw() +
theme(legend.position = "none",
      strip.text = element_blank()
      )
...
# Panel C,D: coverage of cumulatively merged replicates (obsolete)
```{r}
# calculate the median and iqr range
...
scale_x_continuous(limits = c(0.75,4.25)) +
scale_y_continuous(limits = c(0,112), breaks = c(0,25,50,75,100)) +
labs(x = "# of merged experimental replicates", y = "Median VJ coverage, %") +
theme_bw() +
theme(legend.position = "none",
      strip.text = element_blank()
      )
...
scale_x_continuous(limits = c(0.75,4.25)) +
scale_y_continuous(limits = c(0,112), breaks = c(0,25,50,75,100)) +
labs(x = "# of merged experimental replicates", y = "Median CDRL3 coverage, %") +
theme_bw() +
theme(legend.position = "none",
      strip.text = element_blank()
      )
