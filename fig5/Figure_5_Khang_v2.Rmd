...
ggplot(res_ratio_hc %>% filter(blood_state == "blood") %>% filter(Protease != "AspN"), aes(x = log_conc_ratio, y = log_intensity_ratio, color = factor(log_conc_ratio))) +
  ...
  geom_text(data = res_ratio_hc_med_blood, aes(x = log_conc_ratio, y = 4.2, label = round(med2,1)), color = "black", size = 1.75) +
...
#ggsave("./figures/sir_blood.png", height = 5, width = 12, dpi = 600)
```
...
ggplot(res_ratio_lc %>% filter(blood_state == "blood") %>% filter(Protease != "AspN"), aes(x = log_conc_ratio, y = log_intensity_ratio, color = factor(log_conc_ratio))) +
  ...
  scale_color_manual(values = c("black", "black", "black", "black")) +
  scale_fill_manual(values = c("#969696", "#bdbdbd", "#d9d9d9", "#ffffff")) +
  geom_text(data = res_ratio_lc_med_blood, aes(x = log_conc_ratio, y = 4.2, label = round(med2,1)), color = "black", size = 1.75) +
...
#ggsave("./figures/sir_blood_lc.png", height = 5, width = 12, dpi = 600)
```
...
ggplot(res_ratio_hc %>% filter(blood_state == "no blood") %>% filter(Protease != "AspN"), aes(x = log_conc_ratio, y = log_intensity_ratio, color = factor(log_conc_ratio))) +
  ...
  scale_color_manual(values = c("black", "black", "black", "black")) +
  scale_fill_manual(values = c("#969696", "#bdbdbd", "#d9d9d9", "#ffffff")) +
  geom_text(data = res_ratio_hc_med_noblood, aes(x = log_conc_ratio, y = 4.2, label = round(med2,1)), color = "black", size = 1.75) +
...
#ggsave("./figures/sir_noblood.png", height = 5, width = 12, dpi = 600)
```
...
ggplot(res_ratio_lc %>% filter(blood_state == "no blood") %>% filter(Protease != "AspN"), aes(x = log_conc_ratio, y = log_intensity_ratio, color = factor(log_conc_ratio))) +
  ...
  scale_color_manual(values = c("black", "black", "black", "black")) +
  scale_fill_manual(values = c("#969696", "#bdbdbd", "#d9d9d9", "#ffffff")) +
  geom_text(data = res_ratio_lc_med_noblood, aes(x = log_conc_ratio, y = 4.2, label = round(med2,1)), color = "black", size = 1.75) +
...
#ggsave("./figures/sir_noblood_lc.png", height = 5, width = 12, dpi = 600)
```