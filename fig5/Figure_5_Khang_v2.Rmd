...
ggplot(res_ratio_hc %>% filter(blood_state == "blood") %>% filter(Protease != "AspN"), aes(x = log_conc_ratio, y = log_intensity_ratio, color = factor(log_conc_ratio))) +
  ...
  theme_bw() +
  theme(legend.position = "none", axis.text.x = element_text(angle = 90, vjust = 0.45), 
...
#ggsave("./figures/sir_blood_lc.png", height = 8, width = 12, dpi = 600)
```
...
#ggsave("./figures/sir_noblood_lc.png", height = 8, width = 12, dpi = 600)
```