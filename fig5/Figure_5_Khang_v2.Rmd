...
coefs_blood$intercept_eq <-  paste0("Intercept: ", format(round(coefs_blood$intercept,2), digits = 2))
coefs_blood$slope_eq <- paste0("Slope: ", format(round(coefs_blood$slope,2), digits = 2))
coefs_blood$r2_eq <- paste0("R^2 ==", format(round(coefs_blood$r2,2), digits = 2))

coefs_blood_lc$intercept_eq <-  paste0("Intercept: ", format(round(coefs_blood_lc$intercept,2), digits = 2))
coefs_blood_lc$slope_eq <- paste0("Slope: ", format(round(coefs_blood_lc$slope,2), digits = 2))
coefs_blood_lc$r2_eq <- paste0("R^2 ==", format(round(coefs_blood_lc$r2,2), digits = 2))
...
coefs_noblood$intercept_eq <-  paste0("Intercept: ", format(round(coefs_noblood$intercept,2), digits = 2))
coefs_noblood$slope_eq <- paste0("Slope: ", format(round(coefs_noblood$slope,2), digits = 2))
coefs_noblood$r2_eq <- paste0("R^2 ==", format(round(coefs_noblood$r2,2), digits = 2))

coefs_noblood_lc$intercept_eq <-  paste0("Intercept: ", format(round(coefs_noblood_lc$intercept,2), digits = 2))
coefs_noblood_lc$slope_eq <- paste0("Slope: ", format(round(coefs_noblood_lc$slope,2), digits = 2))
coefs_noblood_lc$r2_eq <- paste0("R^2 ==", format(round(coefs_noblood_lc$r2,2), digits = 2))
...
ggplot(res_ratio_hc %>% filter(blood_state == "blood") %>% filter(Protease != "AspN"), aes(x = log_conc_ratio, y = log_intensity_ratio, color = factor(log_conc_ratio))) +
  ...
  geom_abline(data = coefs_blood, aes(intercept = intercept, slope = slope), color = "#DE583E", linewidth = 0.75, linetype = "dashed") +
  ...
  geom_text(data = coefs_blood, aes(-0.75, -3.25, label = intercept_eq), size = 2.25, color = "black", hjust = 0) +
  geom_text(data = coefs_blood, aes(-0.75, -4, label = slope_eq), size = 2.25, color = "black", hjust = 0) +
  geom_text(data = coefs_blood, aes(-0.75, -4.75, label = r2_eq), parse = TRUE, size = 2.25, color = "black", hjust = 0) +
...
ggsave("./figures/sir_blood.png", height = 5.5, width = 12, dpi = 600)
```
...
ggplot(res_ratio_lc %>% filter(blood_state == "blood") %>% filter(Protease != "AspN"), aes(x = log_conc_ratio, y = log_intensity_ratio, color = factor(log_conc_ratio))) +
  geom_point(aes(fill = run1), color = "black", shape = 21, size = 0.1, stroke = 0.03, position = position_jitterdodge()) +
  geom_boxplot(aes(fill = run1), width = 0.5, lwd = 0.3, outlier.shape = NA) +
  geom_abline(data = coefs_blood_lc, aes(intercept = intercept, slope = slope), color = "#DE583E", linewidth = 0.75, linetype = "dashed") +
  ...
  geom_text(data = coefs_blood_lc, aes(-0.75, -3.25, label = intercept_eq), size = 2.25, color = "black", hjust = 0) +
  geom_text(data = coefs_blood_lc, aes(-0.75, -4, label = slope_eq), size = 2.25, color = "black", hjust = 0) +
  geom_text(data = coefs_blood_lc, aes(-0.75, -4.75, label = r2_eq), parse = TRUE, size = 2.25, color = "black", hjust = 0) +
  scale_x_continuous(breaks = 0:3, labels = c(1, 10, 100, 1000)) +
  scale_y_continuous(breaks = -3:4, labels = c(0.001, 0.01, 0.1, 1, 10, 100, 1000, 10000)) +
...
ggsave("./figures/sir_blood_lc.png", height = 5.5, width = 12, dpi = 600)
```
...
ggplot(res_ratio_hc %>% filter(blood_state == "no blood") %>% filter(Protease != "AspN"), aes(x = log_conc_ratio, y = log_intensity_ratio, color = factor(log_conc_ratio))) +
  geom_point(aes(fill = run1), color = "black", shape = 21, size = 0.1, stroke = 0.03, position = position_jitterdodge()) +
  geom_boxplot(aes(fill = run1), width = 0.5, lwd = 0.3, outlier.shape = NA) +
  geom_abline(data = coefs_noblood, aes(intercept = intercept, slope = slope), color = "#DE583E", linewidth = 0.75, linetype = "dashed") +
  ...
  geom_text(data = coefs_noblood, aes(-0.75, -3.25, label = intercept_eq), size = 2.25, color = "black", hjust = 0) +
  geom_text(data = coefs_noblood, aes(-0.75, -4, label = slope_eq), size = 2.25, color = "black", hjust = 0) +
  geom_text(data = coefs_noblood, aes(-0.75, -4.75, label = r2_eq), parse = TRUE, size = 2.25, color = "black", hjust = 0) +
  scale_x_continuous(breaks = 0:3, labels = c(1, 10, 100, 1000)) +
  scale_y_continuous(breaks = -3:4, labels = c(0.001, 0.01, 0.1, 1, 10, 100, 1000, 10000)) +
  facet_grid(factor(match_ig_type, levels = HC_names) ~ factor(Protease, levels = c("Tryp", "Ct", "Ct+Tryp")) + run1) +
  theme_bw() +
...
ggsave("./figures/sir_noblood.png", height = 5.5, width = 12, dpi = 600)
```
...
ggplot(res_ratio_lc %>% filter(blood_state == "no blood") %>% filter(Protease != "AspN"), aes(x = log_conc_ratio, y = log_intensity_ratio, color = factor(log_conc_ratio))) +
  geom_point(aes(fill = run1), color = "black", shape = 21, size = 0.1, stroke = 0.03, position = position_jitterdodge()) +
  geom_boxplot(aes(fill = run1), width = 0.5, lwd = 0.3, outlier.shape = NA) +
  geom_abline(data = coefs_noblood_lc, aes(intercept = intercept, slope = slope), color = "#DE583E", linewidth = 0.75, linetype = "dashed") +
  ...
  geom_text(data = coefs_noblood_lc, aes(-0.75, -3.25, label = intercept_eq), size = 2.25, color = "black", hjust = 0) +
  geom_text(data = coefs_noblood_lc, aes(-0.75, -4, label = slope_eq), size = 2.25, color = "black", hjust = 0) +
  geom_text(data = coefs_noblood_lc, aes(-0.75, -4.75, label = r2_eq), parse = TRUE, size = 2.25, color = "black", hjust = 0) +
  scale_x_continuous(breaks = 0:3, labels = c(1, 10, 100, 1000)) +
  scale_y_continuous(breaks = -3:4, labels = c(0.001, 0.01, 0.1, 1, 10, 100, 1000, 10000)) +
  facet_grid(factor(match_ig_type, levels = LC_names) ~ factor(Protease, levels = c("Tryp", "Ct", "Ct+Tryp")) + run1) +
  theme_bw() +
...
ggsave("./figures/sir_noblood_lc.png", height = 5.5, width = 12, dpi = 600)
```