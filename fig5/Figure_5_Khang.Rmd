...
wc_blood_1 <- res_ratio_hc %>% filter(blood_state == "blood") %>% filter(conc_ratio == "1") %>% group_by(match_ig_type, Protease, conc_ratio, run1) %>% wilcox_test(intensity_ratio~1, alternative = "two.sided", mu = 1, p.adjust.method = "none")
wc_blood_10 <- res_ratio_hc %>% filter(blood_state == "blood") %>% filter(conc_ratio == "10") %>% group_by(match_ig_type, Protease, conc_ratio, run1) %>% wilcox_test(intensity_ratio~1, alternative = "two.sided", mu = 10, p.adjust.method = "none")
wc_blood_100 <- res_ratio_hc %>% filter(blood_state == "blood") %>% filter(conc_ratio == "100") %>% group_by(match_ig_type, Protease, conc_ratio, run1) %>% wilcox_test(intensity_ratio~1, alternative = "two.sided", mu = 100, p.adjust.method = "none")
wc_blood_1000 <- res_ratio_hc %>% filter(blood_state == "blood") %>% filter(conc_ratio == "1000") %>% group_by(match_ig_type, Protease, conc_ratio, run1) %>% wilcox_test(intensity_ratio~1, alternative = "two.sided", mu = 1000, p.adjust.method = "none")

wc_blood <- rbind(wc_blood_1, wc_blood_10, wc_blood_100, wc_blood_1000)
#write_tsv(wc_noblood, "./wc_blood.tsv")

# Adjust for multiple testing
wc_blood$p <- p.adjust(wc_blood$p, method = "BH")
wc_blood$p.signif <- ifelse(wc_blood$p > 0.05, "ns",
                            ifelse(wc_blood$p > 0.01, "*",
                            ifelse(wc_blood$p > 0.001, "**",
                           "***")))
...
# Wilcox test for pairwise difference, but only compare with 4 merged
wc_noblood_1 <- res_ratio_hc %>% filter(blood_state == "no blood") %>% filter(conc_ratio == "1") %>% group_by(match_ig_type, Protease, conc_ratio, run1) %>% wilcox_test(intensity_ratio~1, alternative = "two.sided", mu = 1, p.adjust.method = "none")
wc_noblood_10 <- res_ratio_hc %>% filter(blood_state == "no blood") %>% filter(conc_ratio == "10") %>% group_by(match_ig_type, Protease, conc_ratio, run1) %>% wilcox_test(intensity_ratio~1, alternative = "two.sided", mu = 10, p.adjust.method = "none")
wc_noblood_100 <- res_ratio_hc %>% filter(blood_state == "no blood") %>% filter(conc_ratio == "100") %>% group_by(match_ig_type, Protease, conc_ratio, run1) %>% wilcox_test(intensity_ratio~1, alternative = "two.sided", mu = 100, p.adjust.method = "none")
wc_noblood_1000 <- res_ratio_hc %>% filter(blood_state == "no blood") %>% filter(conc_ratio == "1000") %>% group_by(match_ig_type, Protease, conc_ratio, run1) %>% wilcox_test(intensity_ratio~1, alternative = "two.sided", mu = 1000, p.adjust.method = "none")

wc_noblood <- rbind(wc_noblood_1, wc_noblood_10, wc_noblood_100, wc_noblood_1000)
#write_tsv(wc_noblood, "./wc_noblood.tsv")
# Adjust for multiple testing
wc_noblood$p <- p.adjust(wc_noblood$p, method = "BH")
wc_noblood$p.signif <- ifelse(wc_noblood$p > 0.05, "ns",
                            ifelse(wc_noblood$p > 0.01, "*",
                            ifelse(wc_noblood$p > 0.001, "**",
                           "***")))
...
```{r}
# Create safe version of functions to return NA when encoutering errors
